...
// FetchCategoryUsecase is an autogenerated mock type for the FetchCategoryUsecase type
type FetchCategoryUsecase struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, sort, page, limit
func (_m *FetchCategoryUsecase) Exec(ctx context.Context, sort string, page int, limit int) ([]*domain.Category, int64, error) {
