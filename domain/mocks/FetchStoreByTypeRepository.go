...
// FetchStoreByTypeRepository is an autogenerated mock type for the FetchStoreByTypeRepository type
type FetchStoreByTypeRepository struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, typeID, sort, limit, page
func (_m *FetchStoreByTypeRepository) Exec(ctx context.Context, typeID string, sort string, limit int, page int) ([]*domain.Store, int64, error) {
