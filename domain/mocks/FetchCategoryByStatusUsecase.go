...
// FetchCategoryByStatusUsecase is an autogenerated mock type for the FetchCategoryByStatusUsecase type
type FetchCategoryByStatusUsecase struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, status, sort, page, limit
func (_m *FetchCategoryByStatusUsecase) Exec(ctx context.Context, status string, sort string, page int, limit int) ([]*domain.Category, int64, error) {
