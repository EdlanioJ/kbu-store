...
// FetchStoreByStatusUsecase is an autogenerated mock type for the FetchStoreByStatusUsecase type
type FetchStoreByStatusUsecase struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, status, sort, limit, page
func (_m *FetchStoreByStatusUsecase) Exec(ctx context.Context, status string, sort string, limit int, page int) ([]*domain.Store, int64, error) {
