...
// FetchStoreRepository is an autogenerated mock type for the FetchStoreRepository type
type FetchStoreRepository struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, sort, limit, page
func (_m *FetchStoreRepository) Exec(ctx context.Context, sort string, limit int, page int) ([]*domain.Store, int64, error) {
