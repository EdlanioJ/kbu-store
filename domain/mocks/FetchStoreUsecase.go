...
// FetchStoreUsecase is an autogenerated mock type for the FetchStoreUsecase type
type FetchStoreUsecase struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, sort, limit, page
func (_m *FetchStoreUsecase) Exec(ctx context.Context, sort string, limit int, page int) ([]*domain.Store, int64, error) {
