...
// FetchStoreByOwnerUsecase is an autogenerated mock type for the FetchStoreByOwnerUsecase type
type FetchStoreByOwnerUsecase struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, owner, sort, limit, page
func (_m *FetchStoreByOwnerUsecase) Exec(ctx context.Context, owner string, sort string, limit int, page int) ([]*domain.Store, int64, error) {
