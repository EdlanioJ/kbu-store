...
// FetchTagsByCategoryUsecase is an autogenerated mock type for the FetchTagsByCategoryUsecase type
type FetchTagsByCategoryUsecase struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, category, sort, page, limit
func (_m *FetchTagsByCategoryUsecase) Exec(ctx context.Context, category string, sort string, page int, limit int) ([]*domain.Tag, int64, error) {
