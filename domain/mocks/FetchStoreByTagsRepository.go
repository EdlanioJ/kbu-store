...
// FetchStoreByTagsRepository is an autogenerated mock type for the FetchStoreByTagsRepository type
type FetchStoreByTagsRepository struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, tags, sort, limit, page
func (_m *FetchStoreByTagsRepository) Exec(ctx context.Context, tags []string, sort string, limit int, page int) ([]*domain.Store, int64, error) {
