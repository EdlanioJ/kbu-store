...
func (StoreDBModel) TableName() string {
	return "stores"
}

func (s *StoreDBModel) ParserToDBModel(d *domain.Store) {
	s.ID = d.ID
	s.Name = d.Name
	s.Description = d.Description
	s.ExternalID = d.ExternalID
	s.Status = d.Status
	s.AccountID = d.Account.ID
...
func (s *StoreDBModel) ParserToStoreDomain() (res *domain.Store) {
